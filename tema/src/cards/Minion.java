...
import static gameprocess.Table.PLAYER_ONE_FRONT_ROW;
import static gameprocess.Table.PLAYER_ONE_BACK_ROW;
import static gameprocess.Table.PLAYER_TWO_FRONT_ROW;
import static gameprocess.Table.PLAYER_TWO_BACK_ROW;
...
public final class Minion extends Card {
    ...
    /**
     * @return the index of the player whose card belongs to
     */
